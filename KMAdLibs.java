...
//*File: FinalProj/KMAdLibs.java @Kao-Morakinyo 
//Partner:Oluwakayikunmi Babatunde OB

import java.io.File;
import java.io.PrintWriter;
import java.util.Scanner;
import java.util.*;
public class KMAdLibs 
{
    ...
    {
        System.out.println("Growing up, my " + F.get((int)(Math.random()* ad.size())) + " always told me about former president John F Kennedy. He was born in " + Nu.get((int)(Math.random()* ad.size())) + " and lived with his " + F.get((int)(Math.random()* ad.size())) + " till he died. " + " JFK was extremely " + ad.get((int)(Math.random()* ad.size())) + ", but people believed he was afraid of " + N.get((int)(Math.random()* ad.size())) + "s. Everyday, he would be " + V.get((int)(Math.random()* ad.size())) + " to his " + F.get((int)(Math.random()* ad.size())) + ". But one day, he was " + V.get((int)(Math.random()* ad.size())) + " leading to his death.");
    }
